...
public class RainServiceApi {
    private ApiClient apiClient;

    public RainServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public RainServiceApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call cancelAndDeleteBatchExecutionCall(String executionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/rainService/1.0/batch/{executionId}"
    ...
    /**
     * Cancels and deletes all batch executions for rainService.
     * 
     * @param executionId Execution id of the execution. (required)
     * @return List&lt;String&gt;
    ...
    /**
     * Cancels and deletes all batch executions for rainService. (asynchronously)
     * 
     * @param executionId Execution id of the execution. (required)
    ...
    /**
     * Build call for consumeWebService
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call consumeWebServiceCall(InputParameters webServiceParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = webServiceParameters;
        
        // create path and map variables
        String localVarPath = "/api/rainService/1.0";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call consumeWebServiceValidateBeforeCall(InputParameters webServiceParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'webServiceParameters' is set
        if (webServiceParameters == null) {
            throw new ApiException("Missing the required parameter 'webServiceParameters' when calling consumeWebService(Async)");
        }
        
        
        com.squareup.okhttp.Call call = consumeWebServiceCall(webServiceParameters, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * 
     * Consume the rainService web service.
     * @param webServiceParameters Input parameters to the web service. (required)
     * @return WebServiceResult
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public WebServiceResult consumeWebService(InputParameters webServiceParameters) throws ApiException {
        ApiResponse<WebServiceResult> resp = consumeWebServiceWithHttpInfo(webServiceParameters);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<WebServiceResult> consumeWebServiceWithHttpInfo(InputParameters webServiceParameters) throws ApiException {
        com.squareup.okhttp.Call call = consumeWebServiceValidateBeforeCall(webServiceParameters, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call consumeWebServiceAsync(InputParameters webServiceParameters, final ApiCallback<WebServiceResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = consumeWebServiceValidateBeforeCall(webServiceParameters, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<WebServiceResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call getBatchExecutionFileCall(String executionId, Integer index, String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/rainService/1.0/batch/{executionId}/{index}/files/{fileName}"
            .replaceAll("\\{" + "executionId" + "\\}", apiClient.escapeString(executionId.toString()))
    ...
    /**
     * Gets a specific file from an execution in rainService.
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @param fileName Name of the file to be returned. (required)
    ...
    /**
     * Gets a specific file from an execution in rainService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @param fileName Name of the file to be returned. (required)
    ...
    public com.squareup.okhttp.Call getBatchExecutionFilesCall(String executionId, Integer index, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/rainService/1.0/batch/{executionId}/{index}/files"
            .replaceAll("\\{" + "executionId" + "\\}", apiClient.escapeString(executionId.toString()))
            .replaceAll("\\{" + "index" + "\\}", apiClient.escapeString(index.toString()));
    ...
    /**
     * Gets all files from an individual execution in rainService.
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @return List&lt;String&gt;
    ...
    /**
     * Gets all files from an individual execution in rainService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * Gets all batch executions for rainService.
     * 
     * @param executionId Execution id of the execution (required)
     * @param showPartialResults Returns the already processed results of the batch execution even if it hasn&#39;t been fully completed. (optional)
    ...
    /**
     * Gets all batch executions for rainService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param showPartialResults Returns the already processed results of the batch execution even if it hasn&#39;t been fully completed. (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    public com.squareup.okhttp.Call getBatchExecutionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/rainService/1.0/batch";
    ...
    /**
     * 
     * Consume the rainService web service asynchronously.
     * @param batchWebServiceParameters Input parameters to the web service. (required)
     * @param parallelCount Number of threads used to process entries in the batch. Default value is 10. Please make sure not to use too high of a number because it might negatively impact performance. (optional)
