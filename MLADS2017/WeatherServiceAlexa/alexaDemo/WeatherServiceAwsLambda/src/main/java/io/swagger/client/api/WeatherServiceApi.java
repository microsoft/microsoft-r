...
public class WeatherServiceApi {
    ...
    public com.squareup.okhttp.Call cancelAndDeleteBatchExecutionCall(String executionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/WeatherService/v1.0.0/batch/{executionId}"
    ...
    /**
     * Cancels and deletes all batch executions for WeatherService. (asynchronously)
     * 
     * @param executionId Execution id of the execution. (required)
    ...
    public com.squareup.okhttp.Call getBatchExecutionFileCall(String executionId, Integer index, String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/WeatherService/v1.0.0/batch/{executionId}/{index}/files/{fileName}"
            .replaceAll("\\{" + "executionId" + "\\}", apiClient.escapeString(executionId.toString()))
    ...
    /**
     * Gets a specific file from an execution in WeatherService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @param fileName Name of the file to be returned. (required)
    ...
    public com.squareup.okhttp.Call getBatchExecutionFilesCall(String executionId, Integer index, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/WeatherService/v1.0.0/batch/{executionId}/{index}/files"
            .replaceAll("\\{" + "executionId" + "\\}", apiClient.escapeString(executionId.toString()))
            .replaceAll("\\{" + "index" + "\\}", apiClient.escapeString(index.toString()));
    ...
    /**
     * Gets all files from an individual execution in WeatherService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param index Index of the execution in the batch. (required)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * Gets all batch executions for WeatherService. (asynchronously)
     * 
     * @param executionId Execution id of the execution (required)
     * @param showPartialResults Returns the already processed results of the batch execution even if it hasn&#39;t been fully completed. (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    public com.squareup.okhttp.Call getBatchExecutionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/WeatherService/v1.0.0/batch";
    ...
    /**
     * Build call for getWeatherReport
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWeatherReportCall(InputParameters webServiceParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = webServiceParameters;
        
        // create path and map variables
        String localVarPath = "/api/WeatherService/v1.0.0";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getWeatherReportValidateBeforeCall(InputParameters webServiceParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'webServiceParameters' is set
        if (webServiceParameters == null) {
            throw new ApiException("Missing the required parameter 'webServiceParameters' when calling getWeatherReport(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getWeatherReportCall(webServiceParameters, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public WebServiceResult getWeatherReport(InputParameters webServiceParameters) throws ApiException {
        ApiResponse<WebServiceResult> resp = getWeatherReportWithHttpInfo(webServiceParameters);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<WebServiceResult> getWeatherReportWithHttpInfo(InputParameters webServiceParameters) throws ApiException {
        com.squareup.okhttp.Call call = getWeatherReportValidateBeforeCall(webServiceParameters, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWeatherReportAsync(InputParameters webServiceParameters, final ApiCallback<WebServiceResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWeatherReportValidateBeforeCall(webServiceParameters, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<WebServiceResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
