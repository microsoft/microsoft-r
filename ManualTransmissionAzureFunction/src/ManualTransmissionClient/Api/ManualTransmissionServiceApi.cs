...
namespace ManualTransmissionClient.Api
{
    ...
    /// </summary>
    public interface IManualTransmissionServiceApi : IApiAccessor
    {
        #region Synchronous Operations
        /// <summary>
        /// Cancels and deletes all batch executions for ManualTransmissionService.
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        ...
        /// <summary>
        /// Gets a specific file from an execution in ManualTransmissionService.
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        ...
        /// <summary>
        /// Gets all files from an individual execution in ManualTransmissionService.
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        ...
        /// <summary>
        /// Gets all batch executions for ManualTransmissionService.
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Consume the ManualTransmissionService web service.
        /// </remarks>
        /// <exception cref="ManualTransmissionClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>WebServiceResult</returns>
        WebServiceResult ManualTransmission (InputParameters webServiceParameters);
        ...
        ApiResponse<WebServiceResult> ManualTransmissionWithHttpInfo (InputParameters webServiceParameters);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        /// Consume the ManualTransmissionService web service asynchronously.
        /// </remarks>
        /// <exception cref="ManualTransmissionClient.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        System.Threading.Tasks.Task<WebServiceResult> ManualTransmissionAsync (InputParameters webServiceParameters);
        ...
        System.Threading.Tasks.Task<ApiResponse<WebServiceResult>> ManualTransmissionAsyncWithHttpInfo (InputParameters webServiceParameters);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ManualTransmissionServiceApi : IManualTransmissionServiceApi
    {
        private ManualTransmissionClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ManualTransmissionServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ManualTransmissionServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ManualTransmissionServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<string> > CancelAndDeleteBatchExecutionWithHttpInfo (string executionId)
        {
            ...
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling ManualTransmissionServiceApi->CancelAndDeleteBatchExecution");

            var localVarPath = "/api/ManualTransmissionService/v1.0.0/batch/{executionId}";
        ...
        public ApiResponse< System.IO.Stream > GetBatchExecutionFileWithHttpInfo (string executionId, int? index, string fileName)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling ManualTransmissionServiceApi->GetBatchExecutionFile");
            // verify the required parameter 'index' is set
            if (index == null)
                throw new ApiException(400, "Missing required parameter 'index' when calling ManualTransmissionServiceApi->GetBatchExecutionFile");
            // verify the required parameter 'fileName' is set
            if (fileName == null)
                throw new ApiException(400, "Missing required parameter 'fileName' when calling ManualTransmissionServiceApi->GetBatchExecutionFile");

            var localVarPath = "/api/ManualTransmissionService/v1.0.0/batch/{executionId}/{index}/files/{fileName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< List<string> > GetBatchExecutionFilesWithHttpInfo (string executionId, int? index)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling ManualTransmissionServiceApi->GetBatchExecutionFiles");
            // verify the required parameter 'index' is set
            if (index == null)
                throw new ApiException(400, "Missing required parameter 'index' when calling ManualTransmissionServiceApi->GetBatchExecutionFiles");

            var localVarPath = "/api/ManualTransmissionService/v1.0.0/batch/{executionId}/{index}/files";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< BatchWebServiceResult > GetBatchExecutionStatusWithHttpInfo (string executionId, bool? showPartialResults = null)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling ManualTransmissionServiceApi->GetBatchExecutionStatus");
        ...
        public ApiResponse< List<string> > GetBatchExecutionsWithHttpInfo ()
        {
            ...
            var localVarPath = "/api/ManualTransmissionService/v1.0.0/batch";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>WebServiceResult</returns>
        public WebServiceResult ManualTransmission (InputParameters webServiceParameters)
        {
             ApiResponse<WebServiceResult> localVarResponse = ManualTransmissionWithHttpInfo(webServiceParameters);
             return localVarResponse.Data;
        }
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>ApiResponse of WebServiceResult</returns>
        public ApiResponse< WebServiceResult > ManualTransmissionWithHttpInfo (InputParameters webServiceParameters)
        {
            // verify the required parameter 'webServiceParameters' is set
            if (webServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'webServiceParameters' when calling ManualTransmissionServiceApi->ManualTransmission");

            var localVarPath = "/api/ManualTransmissionService/v1.0.0";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ManualTransmission", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>Task of WebServiceResult</returns>
        public async System.Threading.Tasks.Task<WebServiceResult> ManualTransmissionAsync (InputParameters webServiceParameters)
        {
             ApiResponse<WebServiceResult> localVarResponse = await ManualTransmissionAsyncWithHttpInfo(webServiceParameters);
             return localVarResponse.Data;
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>Task of ApiResponse (WebServiceResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<WebServiceResult>> ManualTransmissionAsyncWithHttpInfo (InputParameters webServiceParameters)
        {
            // verify the required parameter 'webServiceParameters' is set
            if (webServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'webServiceParameters' when calling ManualTransmissionServiceApi->ManualTransmission");
        ...
        public ApiResponse< StartBatchExecutionResponse > StartBatchExecutionWithHttpInfo (List<InputParameters> batchWebServiceParameters, int? parallelCount = null)
        {
            ...
            if (batchWebServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'batchWebServiceParameters' when calling ManualTransmissionServiceApi->StartBatchExecution");
