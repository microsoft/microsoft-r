...
wget -O /usr/lib64/microsoft-deployr/9.0.1/Microsoft.DeployR.Server.WebAPI/appsettings.json https://raw.githubusercontent.com/Microsoft/microsoft-r/master/rserver-arm-templates/hdinsight/3.5/WebAPI/appsettings.json 

rm /usr/lib64/microsoft-deployr/9.0.1/Microsoft.DeployR.Server.BackEnd/appsettings.json
wget -O /usr/lib64/microsoft-deployr/9.0.1/Microsoft.DeployR.Server.BackEnd/appsettings.json https://raw.githubusercontent.com/Microsoft/microsoft-r/master/rserver-arm-templates/hdinsight/3.5/BackEnd/appsettings.json 
